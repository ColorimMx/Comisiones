...
Public Class ComAgeTipCob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Comisiones.ComAgeTipCob.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Fecha_Cobro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedComAgeTipCob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComAgeTipCob = New ComAgeTipCob()
        rpt.Site = Me.Site
        Return rpt
    End Function
